...
public enum FamilyXmlConstants {
	FAMILY_ID("FAMILY_ID"), FAMILY_NAME("FAMILY_NAME"), FAMILY_PARENT_NAME_1(
			"FAMILY_PARENT_NAME_2"), FAMILY_PARENT_NAME_2(
			"FAMILY_PARENT_NAME_2"), FAMILY_LAST_NAME("FAMILY_LAST_NAME"), MEMBER_ID(
			"MEMBER_ID"), MEMBER_F_NAME("MEMBER_F_NAME"), MEMBER_L_NAME(
